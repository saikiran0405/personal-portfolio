// import {
//   FaReact, FaJava, FaAws, FaDocker, FaGitAlt,
//   FaHtml5, FaCss3Alt, FaFigma, FaAngular
// } from "react-icons/fa";

// import {
//   SiSpringboot, SiTypescript, SiJavascript,
//   SiKubernetes, SiApachekafka,
...
//       { name: "MS SQL Server", icon: <SiMysql /> }, // closest icon available
//     ],
//   },
//   {
...
//                   <div
//                     key={skill.name}
//                     className="group relative flex items-center justify-center p-6 bg-white/40 backdrop-blur-lg rounded-2xl shadow-md hover:shadow-xl transition duration-300"
//                   >
//                     {/* ICON */}
//                     <div className="text-3xl text-gray-800 group-hover:scale-110 transition">
//                       {skill.icon}
//                     </div>

//                     {/* HOVER LABEL */}
//                     <span className="absolute bottom-2 text-xs text-gray-700 opacity-0 group-hover:opacity-100 transition">
//                       {skill.name}
//                     </span>
//                   </div>
//                 ))}
...
export default function Skills() {
  return (
    <section
      id="skills"
      className="relative bg-gradient-to-r from-pink-100 via-purple-100 to-blue-100 py-12"
    >
      <div className="max-w-6xl mx-auto px-6">
