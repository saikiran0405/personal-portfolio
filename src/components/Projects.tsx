...
export default function Projects() {
  const projects = [
    {
      ...
      links: [
        {
          label: "GitHub",
          url: "https://github.com/SriHarikaV/Revive_Gallery/commits/main/?author=SaiKiran0407",
        },
      ],
    },
    {
      ...
      links: [
        {
          label: "GitHub",
          url: "https://github.com/Anjali0407-git/SAMS-facial-recognition",
        },
      ],
    },
    {
      ...
      links: [
        {
          label: "GitHub",
          url: "https://github.com/Anjali0407-git/public_speaking_app",
        },
        {
          label: "Demo",
          url: "https://drive.google.com/file/d/17Xe7-5CWcfmo-cxSsaf8vqJN7xqrTQ_R/view",
        },
        {
          label: "Paper",
          url: "https://github.com/Anjali0407-git/public_speaking_app/blob/stable/Public_Speaking_Practice_using_VR.pdf",
        },
      ],
    },
    {
      ...
      links: [
        {
          label: "Report",
          url: "https://drive.google.com/file/d/1EcPRb3upkfj6UGA5D5FYhMa_BmdQY6Mf/view",
        },
      ],
    },
    {
  ...
  return (
    <section id="projects" className="bg-gray-100 pt-60 pb-36">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-6">
          {projects.map((project, index) => (
            <Card
              key={index}
              className="min-h-[360px] min-w-[250px] bg-white border-b-gray-50 shadow-sm rounded-lg overflow-hidden flex flex-col hover:shadow-md transition !py-0 !gap-0"
            >
              {/* IMAGE */}
